<?php
/**
 * $Id: example6.php,v 1.3.2.1 2004/12/20 15:54:51 meebey Exp $
 * $Revision: 1.3.2.1 $
 * $Author: meebey $
...
class mybot
{
    function onjoin_greeting(&$irc, &$data)
    {
        ...
        if ($data->channel == '#php')
            ...
            $irc->message(SMARTIRC_TYPE_CHANNEL, '#php', 'hi '.$data->nick);
    }
}
